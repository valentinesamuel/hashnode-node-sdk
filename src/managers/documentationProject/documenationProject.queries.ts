...
export const GET_DOCUMENTATION_PROJECT_V2_MEMBER_QUERY = gql`
  query getDocumentationProjectV2MembersQuery(
    $pageSize: Int!
    $page: Int!
...
export const GET_DOCUMENTATION_PROJECT_PENDING_INVITES = gql`
  query getDocumentationProjectPendingInvitesQuery(
    $pageSize: Int!
    $page: Int!
  ) {
    documentationProject {
...
export const GET_DOCUMENTATION_PROJECT_VIEWS_QUERY = gql`
  query getDocumentationProjectViews(
    $id: ID
    $first: Int!
    $after: String
...
export const GET_DOCUMENTATION_PROJECT_VISITORS_QUERY = gql`
  query getDocumentationProjectVisitors(
    $id: ID
    $first: Int!
    $after: String
...
export const SEARCH_DOCUMENTATION_PROJECT_USERS_QUERY = gql`
  query searchDocumentationProjectUsers(
