...
mutation toggleAllowContributorEditsMutation($input: ToggleAllowContributorEditsInput!) {
...
mutation toggleTextSelectionSharerMutation($input: ToggleTextSelectionSharerInput!) {
